...
/**
 * Class for the Composite of Tabpage "Bitmasks and Key generation"
 * It provides a GUI interface to generate Sphincs keys and displays a Sphincs public key as well as the used seed and bitmasks.
 * 
 * @author Klaus Kaiser
 *
 */
        ...
        btnGenerateKeys.setText(SphincsDescriptions.SphincsDescription_btn_Generation);
          ...
          btnGenerateKeys.addMouseListener(new MouseAdapter() {
               ...
               public void mouseDown(MouseEvent e) {
                   ...
                   txtInformationOutput.setText(SphincsDescriptions.SphincsDescription_keyInfo1 + " " + prk.getLength() + " " + SphincsDescriptions.SphincsDescription_keyInfo2 + " " + puk.getLength() + " " + SphincsDescriptions.SphincsDescription_keyInfo3 );
                   grp_seed.setText(SphincsDescriptions.SphincsDescription_grp_seed + " " + SphincsDescriptions.SphincsDescription_bracket + prk.getSeed().length + " " + SphincsDescriptions.SphincsDescription_bytes);
                   grp_bitmask.setText(SphincsDescriptions.SphincsDescription_grp_bitmask + " " + SphincsDescriptions.SphincsDescription_bracket + SphincsKeyGenerationView.getBitmasksLength(puk.getBitMasks()) + " " + SphincsDescriptions.SphincsDescription_bytes);
                   grp_key.setText(SphincsDescriptions.SphincsDescription_grp_key + " " + SphincsDescriptions.SphincsDescription_bracket + puk.getLength() + " " + SphincsDescriptions.SphincsDescription_bytes);
                  ...
                  for(int i=0; i<bitmaskArray.length;i++) {
                   ...
                   outputTextKey.setStyleRange(new StyleRange(index, endIndex-index+20,  ColorConstants.red, outputTextKey.getBackground() ));
